...
const OfertadasDemat = (() => {
  ...
  function htmlCardProposta(disciplina) {
    ...
    const slotsHtml = entradas.length
      ? entradas.map((e, i) => htmlSlotProposta(e, i, foco && !estaNaJanelaTarde(e))).join("")
  ...
  function renderMatrizGenerica(container, fonte, descricaoEscopo) {
    ...
    container.innerHTML =
      ...
      '<span class="chip-legenda chip-legenda-conflito">Conflito — 2+ turmas no mesmo horário</span>' +
